...
// Had to remove Radiotap headers, since its automatically added (guess from physical layer?)
// Also there were some trailing bytes I had to remove for the packet not to appear malformed in Wireshark
...
uint8_t pwngrid_beacon[] = {
  ...
  
};
...
//  esp_err_t result = esp_wifi_80211_tx(WIFI_IF_AP, pwngrid_beacon, sizeof(pwngrid_beacon), false);
  esp_err_t result = esp_wifi_80211_tx(WIFI_IF_STA, pwngrid_beacon, sizeof(pwngrid_beacon), false);
  delay(random(0, 10));
